...
namespace LessCompilerVsix
{
    internal sealed class CreateConfig
    {
        ...
        private void BeforeQueryStatus(object sender, EventArgs e)
        {
            ...
            _item = GetProjectItem(LessCompilerPackage._dte);
            ...
            button.Visible = button.Enabled = LessCompiler.CompilerService.IsSupported(inputFile);
        ...
        private void AddConfig(object sender, EventArgs e)
        {
            ...
            // Create new config
            LessCompilerPackage._dte.StatusBar.Progress(true, "Compiling file", 0, 3);
            string inputFile = _item.Properties.Item("FullPath").Value.ToString();
            ...
            LessCompilerPackage._dte.StatusBar.Progress(true, "Compiling file", 1, 3);
            ...
            LessCompilerPackage._dte.StatusBar.Progress(true, "Compiling file", 2, 3);
            ...
            LessCompilerPackage._dte.StatusBar.Progress(true, "Creating defaults file", 3, 3);

            CompilerService.Process(configFile, new[] { config });
            LessCompilerPackage._dte.StatusBar.Progress(false, "Compiling file");
        }
