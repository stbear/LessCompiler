...
namespace LessCompilerVsix.Commands
{
    internal sealed class RemoveConfig
    {
        ...
        private void BeforeQueryStatus(object sender, EventArgs e)
        {
            ...
            if (!LessCompiler.CompilerService.IsSupported(sourceFile))
                return;
        ...
        private void AddConfig(object sender, EventArgs e)
        {
            ...
            {
                Logger.Log(ex);
                LessCompilerPackage._dte.StatusBar.Text = $"Could not update {Constants.CONFIG_FILENAME}. Make sure it's not write-protected or has syntax errors.";
            }
        }
    }
}
