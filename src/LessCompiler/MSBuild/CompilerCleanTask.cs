...
namespace LessCompiler
{
    ...
    public class CompilerCleanTask : Task
    {
        ...
        public override bool Execute()
        {
            ...
            Log.LogMessage(MessageImportance.High, Environment.NewLine + "LessCompiler: Begin cleaning output of " + configFile.Name);
            ...
            try
            {
                ...
                Log.LogMessage(MessageImportance.High, "LessCompiler: Done cleaning output of " + configFile.Name);
